    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                // ディゾルブエッジの計算
                float edge = smoothstep(_DissolveAmount, _DissolveAmount + _EdgeWidth, dissolveValue);
                fixed4 dissolveEdgeColor = _EdgeColor * (1 - edge);
                ...
                // ディゾルブエッジをブレンドする
                finalColor = lerp(finalColor, dissolveEdgeColor, dissolveEdgeColor.a);
